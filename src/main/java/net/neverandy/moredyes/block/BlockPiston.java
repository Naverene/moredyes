...
public class BlockPiston extends DirectionalBlock {
    ...
    public BlockPiston(boolean sticky, AbstractBlock.Properties properties) {
        super(properties);
    ...
    private boolean doMove(World worldIn, BlockPos pos, Direction directionIn, boolean extending) {
        ...
        if (!pistonblockstructurehelper.canMove()) {
            ...
            if (extending) {
                ...
                BlockState blockstate4 = Blocks.PISTON_HEAD.getDefaultState().with(BlockPistonHead.FACING, directionIn).with(BlockPistonHead.TYPE, pistontype);

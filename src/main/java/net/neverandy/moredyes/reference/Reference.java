...
public class Reference
{
    ...
    public static final BlockInfo BLOCK_INFO_GLOWSTONE = new BlockInfo("glowstone",Material.GLASS,0.3f,SoundType.GLASS,ToolType.PICKAXE,1);
    ...
    public static final BlockInfo BLOCK_INFO_PLANK = new BlockInfo("plank",Material.WOOD,2.0f,SoundType.WOOD,ToolType.AXE,0,5.0f, ModSetup.tabTrees);
    public static final BlockInfo BLOCK_INFO_TULIP = new BlockInfo("tulip",Material.PLANT,0.0f,SoundType.GRASS,null,0,1.0f,ModSetup.tabPlants);
    public static final BlockInfo BLOCK_INFO_LOG = new BlockInfo("log",Material.WOOD,2.0f,SoundType.WOOD,ToolType.AXE,0,1.0f, ModSetup.tabTrees);
    public static final BlockInfo BLOCK_INFO_LEAVES = new BlockInfo("leaf",Material.LEAVES,0.2f,SoundType.GRASS,ToolType.AXE,0,1.0f,ModSetup.tabTrees);
    public static final BlockInfo BLOCK_INFO_SAPLING = new BlockInfo("sapling",Material.PLANT,0.0f,SoundType.GRASS,null,0,1.0f,ModSetup.tabTrees);
